...
extern int   AddWinMsgRend (const char *, uint64_t);
...
extern uint64_t ParseAttrColor (char *, int);
extern void  ApplyAttrColor (uint64_t, struct mchar *);
...
extern int   TelOpenAndConnect (struct win *);
